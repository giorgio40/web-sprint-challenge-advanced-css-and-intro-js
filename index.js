  ...
  */
  function getArtistByIndex(array, number) {
      //   return array[number]
      return `The artist at  ${number} is ${array[number].name}`;
  ...
  function get20s(array) {
      ...
      for (let index = 0; index < array.length; index++) {
          if (artists[index].years.split(" - ")[0] > 1899 && (artists[index].years.split(" - ")[1] < 2000)) {
              jibjab.push(artists[index].name)
          }
  ...
  */
  ...
  function addArtist() {
      let newObject = { id: 20, name: "George", genre: "Web Design", nationality: "Greek", bio: "blah blah blah" }
